...
class __Mustache_98d3cae57c100d9f2652d25acea7e810 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $value;
        $buffer .= '" class="rui-topbar-special-btn" data-toggle="tooltip" data-placement="left" title="';
