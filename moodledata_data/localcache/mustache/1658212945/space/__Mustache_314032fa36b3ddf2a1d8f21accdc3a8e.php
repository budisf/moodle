...
class __Mustache_314032fa36b3ddf2a1d8f21accdc3a8e extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core/drawer')) {
            $context->pushBlockContext(array(
                'drawercontent' => array($this, 'block90be2e2596884376b07cbae40aa3e829'),
            ));
...
';
    ...
    public function block90be2e2596884376b07cbae40aa3e829($context)
    {
        $indent = $buffer = '';
