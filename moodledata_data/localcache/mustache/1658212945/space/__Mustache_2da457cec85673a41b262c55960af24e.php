...
class __Mustache_2da457cec85673a41b262c55960af24e extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section6b88d3113c1c4d1e8d043a1598c19c03($context, $indent, $value);
    ...
    private function section6b88d3113c1c4d1e8d043a1598c19c03(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . 'require([\'theme_space/drawers\']);
';
                $context->pop();
            }
        }
