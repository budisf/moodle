...
class __Mustache_32d3f51d14c72e7d4ccfd11cd7973f4a extends Mustache_Template
{
...
';
        if ($parent = $this->mustache->loadPartial('core_message/message_drawer_view_overview_section')) {
            $context->pushBlockContext(array(
                ...
                'emptymessage' => array($this, 'block9ae675cd7c1c5514f6ed7f8f35bccb95'),
            ));
...
';
    ...
    public function block9ae675cd7c1c5514f6ed7f8f35bccb95($context)
    {
        $indent = $buffer = '';
        $buffer .= $indent . '        <p>';
        // 'str' section
