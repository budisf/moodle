...
class __Mustache_a51f9eecf52cb3256c21b6b1ecff50ac extends Mustache_Template
{
...
';
        ...
        $buffer .= ' dropdown-btn btn btn-icon btn-info" id="action-menu-toggle-';
            ...
            foreach ($values as $value) {
                ...
                if ($parent = $this->mustache->loadPartial('core/action_menu_link')) {
                    $context->pushBlockContext(array(
                        'actionmenulinkclasses' => array($this, 'block28a72f8443a5c2c3fa047b61b83418af'),
                    ));
...
';
    ...
    public function block28a72f8443a5c2c3fa047b61b83418af($context)
    {
        $indent = $buffer = '';
