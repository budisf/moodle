...
class __Mustache_acd2c77e42b19de23eb2f3e0114a1053 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template')) {
            $context->pushBlockContext(array(
                ...
                'element' => array($this, 'block3588403173c1436980d04060a3a605d5'),
            ));
...
';
    ...
    public function block3588403173c1436980d04060a3a605d5($context)
    {
        $indent = $buffer = '';
