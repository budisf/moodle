...
class __Mustache_75ecbfbf1d1e4ac71364de7ba9c8cdea extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section01ba81bc73d9fffb8286f876da5facf9($context, $indent, $value);
...
';
    ...
    private function sectionDc77dcb75e485121c61d17bd27d21da2(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = 'currentinparentheses, theme_space';
            $result = call_user_func($value, $source, $this->lambdaHelper);
            if (strpos($result, '{{') === false) {
                $buffer .= $result;
            } else {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= 'currentinparentheses, theme_space';
                $context->pop();
            }
        }
    ...
    private function section282f4f7e66da07ee0aa7f30096e4bebc(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
                            <span class="sr-only">{{#str}}currentinparentheses, theme_space{{/str}}</span>
                        ';
            $result = call_user_func($value, $source, $this->lambdaHelper);
            if (strpos($result, '{{') === false) {
                $buffer .= $result;
            ...
            foreach ($values as $value) {
                ...
                // 'str' section
                $value = $context->find('str');
                $buffer .= $this->sectionDc77dcb75e485121c61d17bd27d21da2($context, $indent, $value);
                $buffer .= '</span>
';
                $context->pop();
            }
    ...
    private function section44ca9107c1cd59ee0d1e11ecc0f3d9e0(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                // 'active' section
                $value = $context->find('active');
                $buffer .= $this->section282f4f7e66da07ee0aa7f30096e4bebc($context, $indent, $value);
                $buffer .= $indent . '                    </a>
';
                $buffer .= $indent . '                </li>
';
...
';
    ...
    private function section01ba81bc73d9fffb8286f876da5facf9(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->section44ca9107c1cd59ee0d1e11ecc0f3d9e0($context, $indent, $value);
                // 'last' section
