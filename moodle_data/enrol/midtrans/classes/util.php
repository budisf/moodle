...
/**
 * Midtrans enrolment plugin utility class.
 *
...
final class util
{
     ...
     * @param stdClass $data    Midtrans IPN data
     */
    public static function message_midtrans_error_to_admin($subject, $data)
    {
        $admin = get_admin();
        $site = get_site();
        ...
        $eventdata->subject           = "MIDTRANS ERROR: " . $subject;
    ...
    public static function get_exception_handler()
    {
        return function ($ex) {
            ...
            $logerrmsg = "enrol_midtrans IPN exception handler: " . $info->message;
