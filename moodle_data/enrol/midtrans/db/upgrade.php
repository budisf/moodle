...
/**
 * This file keeps track of upgrades to the midtrans enrolment plugin
 *
...
function xmldb_enrol_midtrans_upgrade($oldversion) {
    ...
    if ($oldversion < 2018053000) {
        ...
        // Midtrans savepoint reached.
        upgrade_plugin_savepoint(true, 2018053000, 'enrol', 'midtrans');
    }

    if ($oldversion < 2018062500) {

        // Define key courseid (foreign) to be added to enrol_midtrans.
        $table = new xmldb_table('enrol_midtrans');
        ...
        // Midtrans savepoint reached.
        upgrade_plugin_savepoint(true, 2018062500, 'enrol', 'midtrans');
    }

    if ($oldversion < 2018062501) {

        // Define key userid (foreign) to be added to enrol_midtrans.
        $table = new xmldb_table('enrol_midtrans');
        ...
        // Midtrans savepoint reached.
        upgrade_plugin_savepoint(true, 2018062501, 'enrol', 'midtrans');
    }

    if ($oldversion < 2018062502) {

        // Define key instanceid (foreign) to be added to enrol_midtrans.
        $table = new xmldb_table('enrol_midtrans');
        ...
        // Midtrans savepoint reached.
        upgrade_plugin_savepoint(true, 2018062502, 'enrol', 'midtrans');
    }
    ...
    if ($oldversion < 2018062503) {
        ...
        // Define index business (not unique) to be added to enrol_midtrans.
        ...
        // Define index receiver_email (not unique) to be added to enrol_midtrans.
        ...
        // Midtrans savepoint reached.
        upgrade_plugin_savepoint(true, 2018062503, 'enrol', 'midtrans');
    }
