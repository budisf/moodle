...
$page = new admin_settingpage('theme_space_block16', get_string('settingsblock16', 'theme_space'));
          ...
          <div class="row justify-content-center align-items-center">
              <div class="col-auto col-sm py-3">
                  <img src="https://roseathemes.com/space/1/pluginfile.php/1/theme_space/spacesettingsimgs/0/mailchimp-primary.svg" alt="Logo" width="200" height="67" class="img-fluid atto_image_button_text-bottom">
              </div>
              <!-- End Col -->
      
              <div class="col-auto col-sm py-3">
                  <img src="https://roseathemes.com/space/1/pluginfile.php/1/theme_space/spacesettingsimgs/0/l.svg" alt="Logo" width="140" height="47" class="img-fluid atto_image_button_text-bottom">
              </div>
              <!-- End Col -->
      
              <div class="col-auto col-sm py-3">
                  <img src="https://roseathemes.com/space/1/pluginfile.php/1/theme_space/spacesettingsimgs/0/forbes-primary.svg" alt="Logo" width="110" height="28" class="img-fluid atto_image_button_text-bottom">
              </div>
              <!-- End Col -->
      
              <div class="col-auto col-sm py-3">
                  <img src="https://roseathemes.com/space/1/pluginfile.php/1/theme_space/spacesettingsimgs/0/capsule-primary.svg" alt="Logo" width="140" height="47" class="img-fluid atto_image_button_text-bottom">
              </div>
              <!-- End Col -->
      
              <div class="col-auto col-sm py-3">
                  <img src="https://roseathemes.com/space/1/pluginfile.php/1/theme_space/spacesettingsimgs/0/fitbit-primary.svg" alt="Logo" width="140" height="47" class="img-fluid atto_image_button_text-bottom">
              </div>
              <!-- End Col -->
          </div>
          <!-- End Row -->
