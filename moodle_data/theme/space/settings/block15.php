...
$page = new admin_settingpage('theme_space_block15', get_string('settingsblock15', 'theme_space'));
          ...
          <div class="row my-5">
              <div class="col-xs-12 col-md-6 rui-img--rounded-fluid">
                  <img src="https://demo.rosea.io/space/1/pluginfile.php/1/theme_space/spacesettingsimgs/0/simg-1.jpeg" alt="pic #1" width="600" height="472">
              </div>
              <div class="col-xs-12 col-md-6 d-flex flex-wrap align-content-center px-lg-6">
                  <div>
                      <h4 class="lead-2 my-3">space makes it easy to create your e-learning website based on Moodle 3.11 and later.</h4>
                      <p>Lorem ipsum was purposefully designed to have no meaning, but appear like real text, making it the perfect placeholder.</p>
                      <a href="https://demo.rosea.io/space/1/course/" class="btn btn-sm btn-secondary mt-3">Explore theme UI
                      </a>
                  </div>
              </div>
          </div>
          ...
          <div class="row my-5">
              <div class="col-xs-12 col-md-6 d-flex flex-wrap align-content-center px-lg-6">
                  <div>
                      ...
                      <a href="https://demo.rosea.io/space/1/course/" class="btn btn-sm btn-secondary my-3">Learn more about theme</a>
                  </div>
              </div>
      
              <div class="col-xs-12 col-md-6 rui-img--rounded-fluid">
                  <img src="https://demo.rosea.io/space/1/pluginfile.php/1/theme_space/spacesettingsimgs/0/simg-2.png" alt="pic #2" width="600" height="472">
              </div>
          </div>
          <!-- End item -->
          ...
          <div class="row my-5">
              <div class="col-xs-12 col-md-6 rui-img--rounded-fluid">
                  <img src="https://demo.rosea.io/space/1/pluginfile.php/1/theme_space/spacesettingsimgs/0/simg-3.jpeg" alt="pic #4" width="600" height="472">
              </div>
              <div class="col-xs-12 col-md-6 d-flex flex-wrap align-content-center px-lg-6">
                  <div>
                      ...
                      <a href="https://demo.rosea.io/space/1/course/" class="btn btn-sm btn-secondary my-3">Available courses</a>
                  </div>
              </div>
          </div>
          <!-- End item -->
