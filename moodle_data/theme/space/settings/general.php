...
$page = new admin_settingpage('theme_space_general', get_string('generalsettings', 'theme_space'));
    ...
    //TODO: v1.1 Nav items
    // $name = 'theme_space/hgeneralnav';
    // $heading = get_string('hgeneralnav', 'theme_space');
    // $setting = new admin_setting_heading($name, $heading, format_text(get_string('hgeneralnav_desc', 'theme_space'), FORMAT_MARKDOWN));
    // $page->add($setting);

    // $name = 'theme_space/displaysitehome';
    // $title = get_string('displaysitehome', 'theme_space');
    // $description = get_string('displaynavitems_desc', 'theme_space');
    // $default = 1;
    // $setting = new admin_setting_configcheckbox($name, $title, $description, $default);
    // $page->add($setting);

    // $name = 'theme_space/displaydashboard';
    // $title = get_string('displaydashboard', 'theme_space');
    // $description = get_string('displaynavitems_desc', 'theme_space');
    // $default = 1;
    // $setting = new admin_setting_configcheckbox($name, $title, $description, $default);
    // $page->add($setting);

    // $name = 'theme_space/displaycalendar';
    // $title = get_string('displaycalendar', 'theme_space');
    // $description = get_string('displaynavitems_desc', 'theme_space');
    // $default = 1;
    // $setting = new admin_setting_configcheckbox($name, $title, $description, $default);
    // $page->add($setting);
    
    // $name = 'theme_space/displayprivatefiles';
    // $title = get_string('displayprivatefiles', 'theme_space');
    // $description = get_string('displaynavitems_desc', 'theme_space');
    // $default = 1;
    // $setting = new admin_setting_configcheckbox($name, $title, $description, $default);
    // $page->add($setting);

    // $name = 'theme_space/displaycontentbank';
    // $title = get_string('displaycontentbank', 'theme_space');
    // $description = get_string('displaynavitems_desc', 'theme_space');
    // $default = 1;
    // $setting = new admin_setting_configcheckbox($name, $title, $description, $default);
    // $page->add($setting);
