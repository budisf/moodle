...
$block20count = theme_space_get_setting('block20count');
$block20wrapperbg = theme_space_get_setting('block20sliderwrapperbg');
$block20class = theme_space_get_setting('block20class');
$block20introtitle = format_text(theme_space_get_setting('block20introtitle'),FORMAT_HTML, array('noclean' => true));
$block20introcontent = format_text(theme_space_get_setting('block20introcontent'),FORMAT_HTML, array('noclean' => true));
$block20html = format_text(theme_space_get_setting('block20htmlcontent'),FORMAT_HTML, array('noclean' => true));
$block20footer = format_text(theme_space_get_setting('block20footercontent'),FORMAT_HTML, array('noclean' => true));

$title = format_text(theme_space_get_setting("block20herotitle"),FORMAT_HTML, array('noclean' => true));
$caption = format_text(theme_space_get_setting("block20herocaption"),FORMAT_HTML, array('noclean' => true));
$css = theme_space_get_setting("block20herocss");
...
echo '</div>';
if(theme_space_get_setting("displayhrblock20") == '1') {
